...
nix run nixpkgs#omnix -- \
  init github:srid/hsddns -o ./yourproject
```
...
Full instructions: https://srid.ca/hsddns/start
...
- Run the application without installing: `nix run github:srid/hsddns` (or `nix run .` from checkout)
- Common workflows
  - Adding library dependencies in Nix: https://community.flake.parts/haskell-flake/dependency
  - Adding tests: https://srid.ca/hsddns/tests

## Discussions

Questions? Ideas? Suggestions? Join our [NixOS Asia community](https://nixos.asia/en/#community) or post in [Github Discussions](https://github.com/srid/hsddns/discussions).
